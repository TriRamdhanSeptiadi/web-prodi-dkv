...
<html class="no-js" lang="en">
    <head>
        <title>Desain Komunikasi Visual - Profil Lulusan</title>
        <meta charset="utf-8">
    ...
    <body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="">
        ...
        <header class="header-with-topbar">
            <div class="header-top-bar top-bar-dark cover-background" style="background-color: #FFB300; padding-top: 10px; padding-bottom: 10px;">
            ...
            <nav class="navbar navbar-expand-lg header-light header-transparent bg-transparent disable-fixed">
                <div class="container">
                    <a class="navbar-brand" href="international-women-university-beranda.html">
                        ...
                        <span class="brand-text text-black">Desain Komunikasi Visual</span>
                    </a>
                                    ...
                                    <li>
                                        <a href="/tentang"><i class="bi bi-info-circle"></i>
                                            <div class="submenu-icon-content">
                                                <span>Tentang Desain Komunikasi Visual</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center small-screen">
                        <div class="col-lg-8 position-relative text-center page-title-extra-large" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <h1 class="m-auto text-white text-shadow-double-large fw-600 ls-minus-2px">Profil Lulusan</h1>
                        </div>
            ...
            <div class="container text-center">
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden" data-anime='{ "opacity": [0, 1], "translateX": [30, 0], "duration": 600, "delay": 200, "staggervalue": 200, "easing": "easeOutQuad" }'>
                    <div class="card-body p-4">
                        <!-- Judul -->
                        <h5 class="text-dark-gray fw-700" data-anime='{ "opacity": [0, 1], "translate": [0, 0], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>Profil Lulusan Desain Komunikasi Visual</h5>
